        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InfoImages_Infos_InfoId",
                        column: x => x.InfoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrivacyImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrivacyImages_Privacies_PrivacyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrustImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrustImages_Trusts_TrustId",
                        column: x => x.TrustId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Need Shipping from Algeria to Canada", "Looking for shipping Company" },
                    { 2, 1, "Need Commissionnaire de douane", "Tax" }
                });

            migrationBuilder.InsertData(
                table: "Services",
                columns: new[] { "Id", "CategoryId", "Description", "Name" },
                values: new object[] { 1, 1, "Business Trip", "Tourism" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrivacyImages_PrivacyId",
                table: "PrivacyImages",
                column: "PrivacyId");
